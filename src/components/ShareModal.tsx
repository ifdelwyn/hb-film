                ...
                >
                  <div className="w-12 h-12 rounded-full flex items-center justify-center shadow-lg shadow-blue-500/10 group-hover:scale-105 transition-transform duration-300">
                    <svg viewBox="0 0 24 24" className="w-12 h-12">
                      ...
                      <path 
                        d="M12 0C5.373 0 0 4.974 0 11.111c0 3.498 1.737 6.619 4.453 8.565.143.102.227.269.215.447l-.098 2.316c-.021.512.493.882.955.666l2.585-1.205a.897.897 0 01.746.012c1.233.483 2.544.741 3.939.741 6.627 0 12-4.974 12-11.111C24 4.974 18.627 0 12 0z" 
                        fill="url(#messengerGradient)" 
                      />
                      <path 
                        d="M14.22 13.514l-2.22-2.368a.862.862 0 00-1.22 0L6.47 16.514a.306.306 0 01-.466-.379l3.328-5.275a.862.862 0 000-1.026l-2.22-2.368a.862.862 0 011.22-1.22l2.22 2.368a.862.862 0 001.22 0l4.31-5.368a.306.306 0 01.466.379l-3.328 5.275a.862.862 0 000 1.026l2.22 2.368a.862.862 0 01-1.22 1.22z" 
                        fill="#ffffff" 
                      />
                    </svg>
                  </div>
